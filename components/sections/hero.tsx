...
export const HeroSection = () => {
    return (
        <div className="w-full mt-5 mb-20">
                ...
                <div className="flex flex-col p-2"> {/* Main flexbox */}
                    <div className="flex flex-col">
                        <div className="flex flex-row p-2">
                            ...
                            <Button className="rounded-[20px] bg-transparent text-black border-[1.5px] border-zinc-900 pointer-events-none">
                                01
                            </Button>
                            </div>
            ...
            {/* Hero-section-3 */}
            <div className="w-full h-full p-[20px] border-[1.5px] rounded-[20px] bg-transparent mt-4">
                <div className="flex flex-col p-2">
